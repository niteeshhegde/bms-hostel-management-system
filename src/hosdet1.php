...
<table class='table table-striped table-hover ' text-align='center'>
  <thead>
    <tr><td colspan='1'><h4>Name: ". $arry['name']."</h4></td><td colspan='1'><h4>STUDENT ID: " . $arry['stuid']."</h4></td><td colspan='1'><h4>ROOM NO: " . $arry['rooom']."</h4></td></tr>
  </thead>
</table> 
</div>";
}
...
<table class='table table-striped table-hover ' text-align='center'>
  <thead>
    <tr><td colspan='3'><h4>Vacancies: " . (200-$i)."</h4></td></tr>
  </thead>
</table> 
</div>";
