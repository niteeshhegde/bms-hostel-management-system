...
<div class="row">
    <div class="col-md-8">
      <section>      
        <h1 class="entry-title"><span>Incharge SignIn</span> </h1>
        <hr>
            <form class="form-horizontal" method="post" name="signip" id="signup"  action="inchargelogin.php">        
                <div class="form-group">
          <label class="control-label col-sm-3">INCHARGE ID <span class="text-danger">*</span><br></label>
