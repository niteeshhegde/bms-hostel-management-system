...
if($_GET['code'])
{
	...
	if($get_sid == $db_sid && $get_code == $db_code)
	{
		echo '
		<div class="row">
    <div class="col-md-8">
      <section>      
        ...
        <hr>
            <form class="form-horizontal" action="sf4.php?code='.$get_code.'" method="POST" name="signip" id="signup" >        
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              ...
              <input type="password" class="form-control" name="newpass1" id="password" placeholder="Confirm Password" >
				...
				<input type="hidden" name="sid" value="'.$db_sid.'">
